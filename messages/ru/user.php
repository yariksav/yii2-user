...
return [
    'You can not delete yourself!'=>'Невозможно удалить самого себя',
    'Users'=>'Пользователи',
    'Status'=>'Статус',
    'Active'=>'Активный',
    ...
    'Permissions'=>'Резрешения',
    'Role'=>'Роль',
    'Roles'=>'Роли',
    'New role'=>'Новая роль',
    'New user'=>'Новый пользователь',
    'Run for search and insert new permissions?'=>'Запустить поиск и обновление привилегий?',
    'Load for permissions update'=>'Загрузить обновления привилегий',
    'Processed {count} permissions, inserted new {inserted}'=>'Обработано {count} привилегий, вставлено новых {inserted}',
    'Really delete role {0}?'=>'Действительно удалить роль {0}?',
    'Roles assigned to the group'=>'Роли, привязанные к группе',
    'Edit' => 'Редактировать',
    'Delete' => 'Удалить',
    ...
    'Do you want to exit application?'=>'Действительно выйти из приложения?',
